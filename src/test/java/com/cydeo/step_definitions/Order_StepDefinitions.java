  ...
  //  }
     @And("user enters quantity {int}")
      public void userEntersQuantity(int arg0) {
        ...
        //imitatinf pressing back_spacebutton from keyboard to delete existing input
    ...
    public void user_should_see_in_first_row_of_the_web_table(String expectedName) {
        Assert.assertTrue (viewAllOrdersPage.newCustomerCell.getText().equalsIgnoreCase(expectedName));
    }
